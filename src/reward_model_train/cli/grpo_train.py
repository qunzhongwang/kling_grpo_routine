"""GRPO training entry point using the Qwen VL trainer (without vLLM)."""
...
from trl import GRPOConfig, GRPOTrainer_qwen, ModelConfig, ScriptArguments, TrlParser, get_peft_config
...
def make_parser(subparsers: argparse._SubParsersAction | None = None) -> TrlParser:
    ...
    if subparsers is not None:
        return subparsers.add_parser("grpo", help="Run GRPO training", dataclass_types=dataclass_types)
