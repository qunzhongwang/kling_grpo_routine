experiment_name=grpo_human_body_qwen

CUDA_VISIBLE_DEVICES=0 RANK=0 WORLD_SIZE=1 LOCAL_RANK=0 MASTER_ADDR=localhost MASTER_PORT=29500 \
    python -m reward_model_train.cli.agent_grpo_train \
